...
import argparse
import configparser
from model.ASTGCN_r_convlstm import make_model
...
#params_path = '/home/wys/ASTGCN-r-pytorch-master/experiments/PEMS04/astgcn_r_h1d0w0_channel1_5.000000e-03/2023-03-07-10-07-25'
...
def train_main():
    ...
    global params_path 
    params_path = os.path.join('experiments', dataset_name, folder_dir,time_start )
    ...
    # apply the best model on the validation and test sets
    predict_main(best_epoch, val_loader, val_target_tensor, metric_method, _mean, _std, 'val')
...
if __name__ == "__main__":
    params_path = 'experiments/PEMS04/astgcn_r_h1d0w0_channel1_5.000000e-03/2026-06-07-16-55-22'
    best_epoch = 78
    ...
    #predict_main(best_epoch, train_loader, train_target_tensor, metric_method, _mean, _std, 'train')
